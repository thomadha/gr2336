...
public class MovieTest {
  ...
  /**
   * Tests if name assigning is correct when using contructor 3 inputs.
   *
   * @throws IllegalArgumentException if wrong name
   */
  @Test
   ...
   *
   * @throws IllegalArgumentException if score wrong.
   */
  @Test
   ...
   * Tests if score assigning is correct when using contructor.
   *
   * @throws IllegalArgumentException if genre wrong
   */
  @Test
  ...
  //TESTS CONSTRUCTOR WITH 4 INPUTS
  /**
   * Tests if name assigning is correct when using contructor 4 inputs.
   *
   * @throws IllegalArgumentException if name wrong
   */
  @Test
  @DisplayName("Checks if the name is correct")
  ...
  */
  ...
  public void testToString() {
    ...
    shark.setGenre("horror");
    Assertions.assertEquals(("Shark 2 \n - Genre: horror - Score: 2.0 - Views: 2"), shark
          .toString());
  }
