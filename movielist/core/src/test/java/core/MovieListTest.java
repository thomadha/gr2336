...
public class MovieListTest {
   ...
   *
   * @throws IllegalArgumentException is sortings not correct.
   */
  @Test
   ...
   *
   * @throws IllegalArgumentException if sorting doesnt work.
   */
  @Test
   ...
   *
   * @throws IllegalArgumentException if sorting doen't work
   */
  @Test
  @DisplayName("Check sort by best ratings work")
   ...
   *
   * @throws IllegalArgumentException if it doesn't work.
   */
  @Test
